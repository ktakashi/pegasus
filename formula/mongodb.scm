(formula
 ...
 (source 
  ...
  :url "https://github.com/ktakashi/r6rs-mongodb/archive/19.04.23.tar.gz")
 (install (directories ("src") ("contrib/authenticate/src")))
 (tests (test :file "test/bson-parser.scm" :style srfi-64 :loadpath ("src" "test/lib"))
	...
	(test :file "test/session.scm" :style srfi-64 :loadpath ("src" "test/lib")))
 )
